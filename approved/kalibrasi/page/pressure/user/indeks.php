...
<div class="all">
    ...
    <div class="dread">
        ...
        <div class="page">
        <a class="link-dark link-offset-2 link-underline-opacity-0" href="user.php?username=<?php echo $_GET['username']; ?>&bagian=<?php echo $_GET['bagian']; ?>&token=<?php echo htmlspecialchars($_SESSION['token']); ?>">
            <div class="box">
