...
<body>
    <div class="container">
        ...
        <div class="fill">
            ...
            <b>></b>
            <a href="./pump.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>">MOTOR PUMP</a>
        </div>
        ...
        <div class="form">
            <table border="1" cellspacing="0" cellpadding="5" style="border-collapse: collapse;">
                ...
                <tbody style="border: none;">
                    ...
                    <tr>
                        <td colspan="4">
                            <input type="text" name="keterangan1" id="keterangan1" class="keterangan oren">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="4">
                            <input type="text" name="keterangan2" id="keterangan2" class="keterangan oren">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="4">
                            <input type="text" name="keterangan3" id="keterangan3" class="keterangan oren">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="4">
                            <input type="text" name="keterangan4" id="keterangan4" class="keterangan oren">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="4">
                            <input type="text" name="keterangan5" id="keterangan5" class="keterangan oren">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="4">
                            <input type="text" name="keterangan6" id="keterangan6" class="keterangan oren">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="4">
                            <input type="text" name="keterangan7" id="keterangan7" class="keterangan oren">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="4">
                            <input type="text" name="keterangan8" id="keterangan8" class="keterangan oren">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="4">
                            <input type="text" name="keterangan9" id="keterangan9" class="keterangan oren">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="4">
                            <input type="text" name="keterangan10" id="keterangan10" class="keterangan oren">
                        </td>
                        <td>
